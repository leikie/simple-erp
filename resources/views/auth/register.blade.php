                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group mt-4 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input name="name" id="name" type="name" class="form-control @error('name') is-invalid @enderror"
                        ...
                        <div class="form-group mt-4 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input name="email" id="text" type="email" class="form-control @error('email') is-invalid @enderror"
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input name="password" type="password" placeholder="{{ __('Password') }}" class="form-control @error('password') is-invalid @enderror" id="password"
