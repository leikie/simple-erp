...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('orders.store') }}" id="submit-orders">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-12 col-md-4 col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="loan_date" class="form-control @error('loan_date') is-invalid @enderror datepicker-input" id="loan_date" type="date" placeholder="dd/mm/yyyy">
                                        @error('load_date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="product_id" class="@error('product_id') is-invalid @enderror form-select select-product">
                                        ...
                                        @foreach($products as $p)
                                            <option value="{{ $p->id }}">{{ strtoupper($p->product_name) }}</option>
                                        @endforeach
                                    </select>
                                    @error('product_id')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-12 col-md-6 col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <input readonly name="police_number" id="police_number" value="" class="form-control" type="text" >
                                    @error('police_number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-nowrap mb-0 no-footer add-table-items">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <input readonly type="text" id="merk" class="form-control">
                                                    </td>
                                                    <td>
                                                        <input readonly type="text" id="type" class="form-control">
                                                    </td>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div id="collapseThree" class="panel-collapse" role="tabpanel" aria-labelledby="headingThree" data-bs-parent="#accordion">
                                                    <div class="panel-body">
                                                        <input value="1" readonly type="number" id="qty" class="form-control" name="qty">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
