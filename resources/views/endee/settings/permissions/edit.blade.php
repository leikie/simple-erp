                ...
                <div class="card-body">
                    <form action="{{ route('permissions.update', $permission->id) }}" method="POST">
                        ...
                        <div class="settings-form">
                            <div class="mb-3">
                                <p class="pay-cont">Prefix</p>
                                @foreach ($categories as $key => $c)
                                <label class="custom_radio me-4">
                                    <input type="radio" {{ $prefix[0] == strtolower($c) ? 'checked' : '' }} name="prefix" value="{{ strtolower($c) }}" >
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ $prefix[1] }}" name="name" class="@error('name') is-invalid @enderror form-control" placeholder="create/edit/delete/print ..">
                                @error('name')
